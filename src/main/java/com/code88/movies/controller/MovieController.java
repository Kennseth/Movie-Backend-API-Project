package com.code88.movies.controller;

import com.code88.movies.model.Movie;
import com.code88.movies.service.MovieService;
...
//    }
    ...
    public ResponseEntity<Optional<Movie>> getSingleMovieByImdb(@PathVariable String imdbId){
        return new ResponseEntity<Optional<Movie>>(movieService.getSingleMovieByImdb(imdbId),HttpStatus.OK);
    }
}
